...
document.addEventListener("DOMContentLoaded", () => {
 ...
 function changePage(page) {
    ...
    // Hide all pages
    document.querySelectorAll(".blog-page").forEach((item) => {
    ...
    document.querySelectorAll(".page-btn").forEach((btn) => {
      ...
      btn.classList.add("bg-[#f9f1e7]");
    });

    // Active button
    event.target.classList.remove("bg-[#f9f1e7]");
    event.target.classList.add("bg-yellow-700", "text-white");
  }